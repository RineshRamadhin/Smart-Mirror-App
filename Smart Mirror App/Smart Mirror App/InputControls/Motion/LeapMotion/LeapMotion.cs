            ...
            for (int i = 0; i < gestures.Count; i++)
            {
                ...
                switch (gesture.Type)
                {
                    ...
                    case Gesture.GestureType.TYPE_SCREEN_TAP:
                        ...
                        WriteLine("  Tap id: " + screentap.Id
                                       + ", " + screentap.State
                                       + ", position: " + screentap.Position
                                       + ", direction: " + screentap.Direction);
                        break;
                    default:
                        WriteLine("  Unknown gesture type.");
                        break;
                }
            }
